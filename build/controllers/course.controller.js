...
exports.generateVideoUrl = exports.deleteCourse = exports.getAllCoursesAdmin = exports.addReplyToReview = exports.addReview = exports.addAnswer = exports.addQuestion = exports.getCourseContentByUser = exports.getAllCourses = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
exports.getCourseContentByUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
...
exports.addReview = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isAdmin) {
            return next(new ErrorHandler_1.default("You are an Admin. You cannot add a review", 404));
        }
        if (!courseExists) {
            return next(new ErrorHandler_1.default("You are not eligible to access this course", 404));
        }
        const course = await course_model_1.default.findById(courseId);
        const hasReviewed = course?.reviews.some((review) => review.user._id.toString() === userId.toString());
        if (hasReviewed) {
